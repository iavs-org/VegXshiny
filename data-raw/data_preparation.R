...
templates_lookup = read.csv("data-raw/templates_lookup.csv", stringsAsFactors = F)
...
templates = read.csv("data-raw/templates.csv", stringsAsFactors = F)
...
#### Export data ####
usethis::use_data(templates_lookup, templates, id_lookup, overwrite = TRUE, internal = TRUE)
