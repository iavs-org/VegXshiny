...
Veg-X has not found wide adoption to this date. One of the reasons for this was the lack of tools to easily create 
...
*VegXshiny has a graphical user interface to guide the user through the conversion process*
</center>
...
XML conforms to the Veg-X standard. The ability to view and edit input files and output VegX documents gives users control over their data. Finally, an interactive 
tree viewer of the Veg-X schema helps making the standard accessible.

The development of VegXshiny is endorsed by the [International Association for Vegetation Science (IAVS)](http://iavs.org/) and has been funded by the German Research Foundation (DFG, project number 460840087).
