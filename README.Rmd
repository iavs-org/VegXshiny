...
VegXshiny was developed as a GUI-based application for creating Veg-X documents. It is build around the R package VegX (De Cáceres, 2018) and can be used for the conversion of small to medium sized data-sets. It also allows the conversion from Veg-X documents to table formats.
